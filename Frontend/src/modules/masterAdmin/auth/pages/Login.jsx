...
import { Activity, ArrowRight, Building, Lock, Mail, ShieldCheck, Users } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-slate-900 tracking-tight">System Core Portal</h2>
        <p className="mt-2 text-center text-sm font-medium text-slate-500">Master administrative access only</p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="bg-white py-8 px-4 shadow-xl shadow-slate-200/50 sm:rounded-2xl sm:px-10 border border-slate-100">
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div>
              <label className="block text-sm font-bold text-slate-700 mb-2">Administrative ID</label>
              <div className="relative">
                ...
                <input
                  type="email"
                  required
                  className="appearance-none block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl shadow-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-sky-500 text-sm font-medium text-slate-900 transition-all"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 text-sky-600 focus:ring-sky-500 border-slate-300 rounded cursor-pointer" />
            ...
            <div>
              <button
                ...
                className="w-full flex justify-center items-center gap-2 py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-slate-900 hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-900 transition-colors disabled:opacity-60"
              >
                {isSubmitting ? "Authenticating..." : "Authenticate & Login"} <ArrowRight className="w-4 h-4" />
              </button>
            </div>
